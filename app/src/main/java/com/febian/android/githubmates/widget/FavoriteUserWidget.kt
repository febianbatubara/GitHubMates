...
class FavoriteUserWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.febian.android.githubmates.TOAST_ACTION"
        const val EXTRA_ITEM = "com.febian.android.githubmates.EXTRA_ITEM"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action != null) {
            if (intent.action == TOAST_ACTION) {
                ...
                Toast.makeText(context, "Favorite User ${viewIndex + 1}", Toast.LENGTH_SHORT).show()
            }
        }
    }
}